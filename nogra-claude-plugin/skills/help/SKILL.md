...
`references/usage.md` as the source for general help content. For routing and
language defaults, read `references/routing.md`. For runtime, model/effort
preference and status/version details, read `references/runtime.md`. Summarize
the relevant section instead of dumping the full reference unless the user
